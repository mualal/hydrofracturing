...
\usemintedstyle[Python]{staroffice}
\newminted{python}{fontsize=\scriptsize, linenos=false, frame=single, framesep=10pt}
...
%    pdfpagelabels=false,        % set PDF page labels (true|false)
    ...
    pdfborder={0 0 0}, % The style of box around links; defaults to a box with lines of 1pt thickness, but the colorlinks option resets it to produce no border.
%    linkcolor={linkcolor},
