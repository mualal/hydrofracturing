...
%\addbibresource[label=other]{settings/biblio/othercites.bib}
%\addbibresource[label=vak]{settings/biblio/authorpapersVAK.bib}
%\addbibresource[label=papers]{settings/biblio/authorpapers.bib}
%\addbibresource[label=conf]{settings/biblio/authorconferences.bib}
...
%            \perdatasource{settings/biblio/authorpapersVAK.bib}
%            \perdatasource{settings/biblio/authorpapers.bib}
%            \perdatasource{settings/biblio/authorconferences.bib}
...
%            \perdatasource{settings/biblio/othercites.bib}
